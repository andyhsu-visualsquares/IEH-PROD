 ...
 *
 **/
define(['N/record', 'N/https', 'N/url', 'N/error', 'N/log', 'N/search', 'N/config', '../../DAO/CustomerDAO'], function (
    record,
    https,
    url,
    error,
    ...
    function afterSubmit(context) {
        ...
        if (context.type != context.UserEventType.DELETE && context.type != context.UserEventType.XEDIT) {
            ...
            if (customerObj.custentity_iv_cl_member_type)
                if (customerObj.custentity_iv_cl_member_type[0])
                    customerCurrentTier = customerObj.custentity_iv_cl_member_type[0].value
