...
{	
	...
	// for (var xx = 3; xx > 0; xx--)
	// for (var xx = 136; xx > 0; xx--) // 92 = 07/11/2021
	// for (var xx = 142; xx > 130; xx--)
	for (var xx = 1; xx > 0; xx--)		//144 17-9-2021
	{
		...
		// lastSyncDateTime = '2021/09/18 00:00:00';
		// lastSyncDateTimeDateEnd = '2021/09/18 18:59:59';
		// vBeginTime:	
		// 2020/01/17 13:40:00
		// vEndTime:	
		// 2020/01/17 14:00:00
		...
		lastSyncDateTimeDateEnd = '2022/01/30 23:59:59';
		// nlapiLogExecution("debug","now",now);
		...
		if(SalesList && SalesList != null && SalesList != 'null' && SalesList != '' )
		{
			...
			for(var i = 0; i < SalesList.length; i++)
			{
				...
				if(ShopNum != 99 && ShopNum != 0)
				{
					...
					//if (SalesNum == 'R992201302512504597')
					{	
						var ShopNum = SalesList[i]['SN'];
